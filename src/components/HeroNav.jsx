      ...
      <div className="flex items-center justify-between w-full mb-6">
        ...
        <div className="flex items-center gap-4">
          ...
          {user ? (
            ...
            <div onClick={() => setShowUserLogin(true)} className='flex items-center gap-2 bg-[#5556cc] text-white px-4 py-3 rounded-full cursor-pointer hover:bg-[#4445bb] transition duration-300 p-regular'>
